...
# Initialize memory for multi-turn context
memory = ConversationBufferMemory(memory_key="chat_history", return_messages=True)

# Initialize retrieval agent with memory enabled
...
# Orchestrator function supporting multi-turn conversational retrieval + summarization
def multi_turn_collaboration(question: str) -> str:
...
if __name__ == "__main__":
    ...
    answer1 = multi_turn_collaboration(question1)
    print("Agent:", answer1)

    # Second turn, continuing the conversation
    question2 = "Who developed LangChain?"
    print("\nUser:", question2)
    answer2 = multi_turn_collaboration(question2)
    print("Agent:", answer2)
